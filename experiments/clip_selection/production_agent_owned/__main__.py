...
from .harness import AgentOwnedSelectionHarness
...
def main(
    ...
    try:
        ...
        harness = AgentOwnedSelectionHarness(model_client=model, frame_source=frames)
